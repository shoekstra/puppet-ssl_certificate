    ...
    context "on #{osfamily}" do
      ...
      describe "install 'www.website.com' certificate" do
        ...
        describe "and install intermediate certificate" do
          ...
          if osfamily == 'Debian'
            it { should contain_file('/usr/share/ca-certificates/managed_by_puppet/www.website.com.intermediate.crt').that_notifies('Exec[update-ca-certificates_www.website.com.intermediate.crt]') }
            ...
            it { should contain_file_line('/etc/ca-certificates.conf__managed_by_puppet/www.website.com.intermediate.crt').that_notifies('Exec[update-ca-certificates_www.website.com.intermediate.crt]') }
            it { should contain_exec('update-ca-certificates_www.website.com.intermediate.crt') }
          end
        end
        ...
        describe "and install CA intermediate" do
          ...
          if osfamily == 'Debian'
            it { should contain_file('/usr/share/ca-certificates/managed_by_puppet/www.website.com.ca.crt').that_notifies('Exec[update-ca-certificates_www.website.com.ca.crt]') }
            ...
            it { should contain_file_line('/etc/ca-certificates.conf__managed_by_puppet/www.website.com.ca.crt').that_notifies('Exec[update-ca-certificates_www.website.com.ca.crt]') }
            it { should contain_exec('update-ca-certificates_www.website.com.ca.crt') }
          end
        end
      end
